...
parser.add_argument('--path1', type=str, default='real image path')
parser.add_argument('--path2', type=str, default='synthesized image path')
...
def _compute_statistics_of_path(path, model, batch_size, dims, cuda):
    if path.endswith('.npz'):
        ...
        dataloader = torch.utils.data.DataLoader(dataset=dataset, batch_size=batch_size, shuffle=False, drop_last=True, num_workers=0)
