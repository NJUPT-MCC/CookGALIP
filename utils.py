...
def load_models_opt(netG, netD, netC, IFBlock, optim_G, optim_D, path, multi_gpus):
    ...
    IFBlock = load_model_weights(IFBlock, checkpoint['model']['IFBlock'], multi_gpus)
    ...
    return netG, netD, netC, IFBlock, optim_G, optim_D
...
def save_models_opt(netG, netD, netC, IFBlock, optG, optD, epoch, multi_gpus, save_path):
